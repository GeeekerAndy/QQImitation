...
/**
 * Created by Andy.
 * Register QQ account. Set nickname, password and check password input type.
 */
        ...
        et_register_userName.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if((et_register_password.getText().toString().length() < 6)
                    ...
                    btn_register.setTextColor(ContextCompat.getColor(RegisterActivity.this, R.color.dark));
